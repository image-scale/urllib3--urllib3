...
- [ ] Task 12: Implement a top-level convenience API with a module-level request function, public exports of all major classes, and helper functions like connection_from_url and proxy_from_url.
